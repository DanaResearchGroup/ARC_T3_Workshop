...
In your Ubuntu virtual machine, create a "Code" directory using the Files application by right clicking on the background, choosing "New Folder" and renaming it "Code".

Next, open a terminal in the that folder.

This can be done by right clicking on the Files background again and choosing "Open In Terminal", or using Ctrl+Alt+T and `cd Code`
...
`bash ARC_T3_Workshop/install_mamba_and_clones.sh`
